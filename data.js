  ...
  "0001": {
    ...
    skills: {
      ...
      basicAttack: {
        ...
        description: `An attack with up to 5 sequences that deals <span style="color: rgb(255, 136, 119)">Heat DMG</span>. 
            As the controller operator, Final Strike also deals 27 <span style="color: #DFBB92">stagger</span>. <br>
            <span style="font-weight: bold">Dive attack:</span> <br> Basic attack performed in mir-air becomes a dive attack that deals Heat DMG to nearby enemies. <br>
            <span style="font-weight: bold">Finisher:</span> <br> Basic attack performed near a Staggered enemy becomes a finisher attack that deals massive Heat DMG and recovers some SP.
            `,
        basicmult: [
          [0.29, 0.33, 0.48, 0.52, 0.71],
          [0.31, 0.37, 0.52, 0.57, 0.78],
      ...
      Ultimate: {
        ...
        description: `Laevatain summons her Sviga Lævi and becomes the controlled operator. For a certain duration, 
          her basic attacks (BATK) are enhanced and the Sviga  Lævi strikes together with Laevatain, with each attack dealing <span style="color: rgb(255, 136, 119)">Heat DMG</span>. 
            while the 2nd and 4th BATK sequences also deal <span style="color: rgb(255, 136, 119)">Heat Infliction</span>`,
        ultextramult: [
          [0.68, 0.81, 1.22, 1.80],
          [0.74, 0.89, 1.34, 1.98],
          [0.81, 0.97, 1.46, 2.16],
